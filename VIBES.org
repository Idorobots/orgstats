...
** DONE Stats command                                                                 :CLI:Analysis:
:LOGBOOK:
- State "DONE"       from "TODO"       [2026-02-21 Sat 18:53] \\
  No comments here, was pretty easy.
:END:
...
** TODO Tasks stats command                                                                 :CLI:UX:
** TODO Tags stats command                                                                  :CLI:UX:
...
** TODO Groups stats command                                                                :CLI:UX:
Add a new ~stats tags~ command to the CLI that allows displaying tag stats for specific tags.
An example invocation will look like this:
